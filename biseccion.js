...
function Biseccion(f,a,b,n){
    ...
    if(CambioSigno(f,a,b)==false){
        return console.log("Para la función ", f, " el método de bisección no es aplicable en el intervalo [", a, ", ", b, "]."); // y salimos de la función 
    }
...
let fun2=x=>x**3-4*x-9; //las funciones con la variable simbolica x se definen así con la flecha
